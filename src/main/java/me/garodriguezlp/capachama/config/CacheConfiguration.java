package me.garodriguezlp.capachama.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, me.garodriguezlp.capachama.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, me.garodriguezlp.capachama.repository.UserRepository.USERS_BY_EMAIL_CACHE);
