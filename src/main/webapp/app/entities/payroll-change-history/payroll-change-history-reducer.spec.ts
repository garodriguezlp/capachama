...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payroll-change-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYROLLCHANGEHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYROLLCHANGEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYROLLCHANGEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYROLLCHANGEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYROLLCHANGEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYROLLCHANGEHISTORY actions', async () => {
      const expectedActions = [
        {
