  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="capachamaApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="capachamaApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('capachamaApp.employee.firstName')}
              ...
              />
              <ValidatedField
                label={translate('capachamaApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('capachamaApp.employee.hireDate')}
