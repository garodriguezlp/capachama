  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="capachamaApp.project.home.createOrEditLabel" data-cy="ProjectCreateUpdateHeading">
            <Translate contentKey="capachamaApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('capachamaApp.project.name')} id="project-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('capachamaApp.project.description')}
              ...
              />
              <ValidatedField
                label={translate('capachamaApp.project.startDate')}
