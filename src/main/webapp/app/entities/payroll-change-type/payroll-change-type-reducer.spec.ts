...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payroll-change-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYROLLCHANGETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYROLLCHANGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYROLLCHANGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYROLLCHANGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYROLLCHANGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYROLLCHANGETYPE actions', async () => {
      const expectedActions = [
        {
