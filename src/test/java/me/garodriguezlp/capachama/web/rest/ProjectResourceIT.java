...
import me.garodriguezlp.capachama.repository.ProjectRepository;
import me.garodriguezlp.capachama.service.dto.ProjectDTO;
import me.garodriguezlp.capachama.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).startDate(DEFAULT_START_DATE);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).startDate(UPDATED_START_DATE);
